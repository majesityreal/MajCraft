package com.majesity.majcraft.blocks.Furnace;
...
public class ContainerScreenFurnace extends ContainerScreen<ContainerFurnace> {
    ...
    protected void drawGuiContainerBackgroundLayer(MatrixStack matrixStack, float partialTicks, int x, int y) {
        ...
        blit(matrixStack, guiLeft + COOK_BAR_XPOS, guiTop + COOK_BAR_YPOS, COOK_BAR_ICON_U, COOK_BAR_ICON_V,
        ...
        for (int i = 0; i < containerFurnace.FUEL_SLOTS_COUNT; ++i) {
            ...
            blit(matrixStack,guiLeft + FLAME_XPOS + FLAME_X_SPACING * i, guiTop + FLAME_YPOS + yOffset,
    ...
    protected void drawGuiContainerForegroundLayer(MatrixStack matrixStack, int mouseX, int mouseY) {
        ...
        font.drawString(matrixStack, title.getString(), LABEL_XPOS, LABEL_YPOS, Color.darkGray.getRGB());
    }
