...
public class ObsidianForgeFuelSlot extends Slot {
    private final AbstractFurnaceContainer field_216939_a;

    public ObsidianForgeFuelSlot(AbstractFurnaceContainer p_i50084_1_, IInventory p_i50084_2_, int p_i50084_3_, int p_i50084_4_, int p_i50084_5_) {
