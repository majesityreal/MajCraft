...
import com.majesity.majcraft.tileentity.BlockObsidianForgeTile;
...
public class BlockObsidianForge extends BlockIronFurnaceBase {

    // public static final String NETHERITE_FURNACE = "netherite_furnace";

    public BlockObsidianForge() {
    ...
    public void onBlockHarvested(World world, BlockPos pos, BlockState state, PlayerEntity player) {
        if (!player.isCreative()) {
            ...
            if (te.hasCustomName()) {
                ItemStack itemstack = new ItemStack(ModBlocks.OBSIDIAN_FORGE.get());
                itemstack.setDisplayName(te.getName());
                world.addEntity(new ItemEntity(world, pos.getX(), pos.getY(), pos.getZ(), itemstack));
            } else {
                world.addEntity(new ItemEntity(world, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModBlocks.OBSIDIAN_FORGE.get())));
            }
        }
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new BlockObsidianForgeTile();
    }
}